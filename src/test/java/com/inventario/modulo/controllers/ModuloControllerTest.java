...
@WebMvcTest(controllers = ModuloController.class, excludeAutoConfiguration = { SecurityAutoConfiguration.class })
...
class ModuloControllerTest {
    ...
    void crear_returns201AndLocationHeader_whenRequestIsValid() throws Exception {
        ...
        ArgumentCaptor<ModuloRequest> captor = ArgumentCaptor.forClass(ModuloRequest.class);
    ...
    void actualizar_returns204_whenRequestIsValid() throws Exception {
        ...
        verify(moduloService).actualizarModulo(org.mockito.ArgumentMatchers.eq(moduloId), org.mockito.ArgumentMatchers.any(ModuloRequest.class));
    }
