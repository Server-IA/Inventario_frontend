...
// @WebMvcTest(controllers = RolController.class, excludeFilters =
...
// new RolResponseDTO(1L, "Operario", "Rol operativo", 1L, "Activo", "admin",
// OffsetDateTime.now(),
// null, null)));
...
// new RolResponseDTO(10L, "Operario", "Rol operativo", 1L, "Activo", "admin",
// OffsetDateTime.now(),
// null, null));
