...
// when(empresaRolService.findAll()).thenReturn(List.of(new EmpresaRolResponseDTO(1L,
// "Empresa A", "Operario", "Activo")));
...
// when(empresaRolService.create(any())).thenReturn(new EmpresaRolResponseDTO(99L,
// "Empresa A", "Operario", "Activo"));
