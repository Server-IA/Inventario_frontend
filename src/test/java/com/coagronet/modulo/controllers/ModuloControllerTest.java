...
// ArgumentCaptor<com.coagronet.modulo.dtos.ModuloRequest> captor =
...
// ArgumentCaptor.forClass(
// com.coagronet.modulo.dtos.ModuloRequest.class);
// verify(moduloService).actualizarModulo(org.mockito.ArgumentMatchers.eq(moduloId),
// captor.capture());
// org.junit.jupiter.api.Assertions.assertEquals(estadoIdInactivo,
// captor.getValue().estadoId());
// }
...
// verify(moduloService).actualizarRequerido(org.mockito.ArgumentMatchers.eq(moduloId),
// captor.capture());
// org.junit.jupiter.api.Assertions.assertEquals(Boolean.FALSE,
// captor.getValue().requerido());
// }
