...
// void getModulosDisponibles_returns200_whenUserIsAuthenticated_currentBehavior() throws
// Exception {
...
// when(rolPermisoService.reemplazarModuloPermisosDeEmpresaRol(any(), any(),
// any())).thenReturn(
// RolPermisoAsignadoResponse.builder().rolId(5L).rolNombre("Operario").permisosAsignados(2).build());
