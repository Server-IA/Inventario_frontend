 ...
 *
 * import com.coagronet.permiso.repositories.PermisoRepository; import
 * com.coagronet.rol.Rol; import com.coagronet.user.User; import
 * com.coagronet.user.repositories.UserRepository; import
 * com.coagronet.usuarioEstado.UsuarioEstado;
 *
 * @ExtendWith(MockitoExtension.class) class MyUserDetailsServiceTest {
 *
 ...
 *
 * @Test void loadUserByUsername_deniesAccessWhenUserIsDeactivated() { String username =
 * "desactivado@coagronet.com";
 *
 ...
 *
 * @Test void loadUserByUsername_loadsRoleAndPermissionAuthoritiesForPreferredEmpresa() {
 * String username = "admin.empresa@coagronet.com"; Long empresaId = 5L;
 *
 * Rol role = Rol.builder().id(7L).nombre("ROLE_ADMINISTRADOR_EMPRESA").build();
 *
 * User user = new User(); user.setId(2L); user.setUsername(username);
 * user.setRoles(Set.of(role)); user.setUsuarioEstado(new UsuarioEstado(4L));
 ...
 *
 * assertThat(authorities) .contains("ROLE_ADMINISTRADOR_EMPRESA",
 * "USUARIO_ROL_INACTIVATE");
