...
public record DatosProduccion(Long id, String nombre, Integer tipoProduccion, String descripcion,
        LocalDateTime fechaInicio, LocalDateTime fechaFinal, Long espacio, Long estado) {
