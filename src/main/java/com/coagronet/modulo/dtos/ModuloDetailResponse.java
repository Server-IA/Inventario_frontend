...
/**
 * Representa la estructura detallada de un {@link com.coagronet.subsistema.Modulo}, optimizada para operaciones de
 * edición o auditoría.
 * <p>
 ...
 * @param estadoId identificador numérico (ID) del {@link com.coagronet.estado.Estado} asignado. Utilizado para
 ...
 * @param tipoModuloId identificador numérico (ID) del {@link com.coagronet.tipomodulo.TipoModulo} que clasifica la
 * naturaleza funcional del módulo.
 * @param tipoAplicacionId identificador numérico (ID) del {@link com.coagronet.tipoaplicacion.TipoAplicacion} que
