...
/**
 * Representa la unidad funcional básica o "Módulo" dentro de la arquitectura
 * del sistema.
 * <p>
 * Esta entidad mapea la tabla <code>modulo</code> y define los componentes
 * navegables o ejecutables
 * que componen un {@link SubSistema}. Implementa reglas de negocio
 * estructurales mediante restricciones
 * de base de datos, garantizando que no existan módulos homónimos dentro del
 * mismo subsistema y tipo de aplicación.
 * </p>
 * <p>
 * Incluye soporte para tipos de datos avanzados de PostgreSQL, como arreglos de
 * cadenas para la gestión
 * de roles, utilizando las extensiones de Hibernate 6.
 * </p>
 *
 * @author jujcgu
 * @version 2.0
...
public class Modulo implements Serializable {
     ...
     * <p>
     * Generado secuencialmente por la base de datos
     * (<code>modulo_mod_id_seq</code>).
     * Se utiliza como criterio de igualdad en los métodos {@code equals} y
     * {@code hashCode}.
     * </p>
     */
    @Id
     ...
     * <p>
     * Este campo forma parte de la llave única compuesta
     * <code>ux_nombre_subsistema_tipo_aplicacion</code>.
     ...
     * <p>
     * Define el punto de entrada para la navegación del usuario (ej.
     * <code>/ventas/facturacion</code>).
     * </p>
     */
     ...
     * <p>
     * Campo opcional de gran longitud (hasta 2048 caracteres) destinado a
     * documentación en línea
     * o tooltips de ayuda para el usuario final.
     * </p>
     */
     ...
     * <p>
     * Referencia obligatoria a la entidad {@link Estado}. Determina si el módulo
     * está activo,
     * inactivo o en mantenimiento. Configurada con carga perezosa
     * ({@code FetchType.LAZY}).
     * </p>
     */
     ...
     * <p>
     * Cadena de texto que referencia una clase CSS (ej. FontAwesome) o la ruta de
     * un activo estático.
     * </p>
     */
     ...
     * <p>
     * Establece la jerarquía de navegación y agrupamiento lógico. Un módulo no
     * puede existir
     * sin estar asociado a un subsistema (relación obligatoria).
     * </p>
     */
    @ManyToOne(fetch = FetchType.LAZY, optional = false)
     ...
     * <p>
     * Referencia a {@link TipoModulo} para distinguir entre módulos de reporte,
     * transaccionales,
     ...
     * <p>
     * Permite reutilizar la estructura de módulos para diferentes entornos (Web,
     * Móvil, Escritorio).
     * </p>
     */
    @ManyToOne(fetch = FetchType.LAZY, optional = false)
    ...
    /**
     * Lista de identificadores de roles autorizados para acceder al módulo.
     * <p>
     * Mapea una columna de tipo arreglo en PostgreSQL (<code>varchar[]</code>)
     * directamente a un arreglo
     * de Java. Esto permite una gestión de seguridad simplificada a nivel de
     * registro.
     * </p>
     */
     ...
     * <p>
     * Utilizado para pruebas automatizadas (E2E) o referencias específicas en el
     * código cliente.
     * </p>
     */
     ...
     * <p>
     * Señala si el módulo es crítico para la operación del sistema y no debe ser
     * desactivado o
     * removido de la configuración base.
     * </p>
     */
