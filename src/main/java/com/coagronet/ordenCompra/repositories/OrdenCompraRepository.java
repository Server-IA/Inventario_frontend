...
public interface OrdenCompraRepository
		extends JpaRepository<OrdenCompra, Long> {/*
													 ...
													 * Integer pedidoId, Long empresaId, Integer estadoId);
													 * 
													 * Optional<OrdenCompra> findByIdAndPedidoAlmacenSedeEmpresaId( Long
													 * id, Long empresaId);
													 * 
													 ...
													 * Long id, Long empresaId, Integer estadoId);
													 */
