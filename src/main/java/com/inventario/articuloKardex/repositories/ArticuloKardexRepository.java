...
package com.inventario.articuloKardex.repositories;
...
public interface ArticuloKardexRepository
	...
	@Query("""
			    SELECT new com.inventario.articuloKardex.dtos.ArticuloKardexDTO(
			        a.id,
			        a.cantidad,
			        a.precio,
			        a.precioTotal,
	...
	@Query("""
			    SELECT new com.inventario.articuloKardex.dtos.KardexItemResponseDto(
			        k.id,
			        p.nombre,
