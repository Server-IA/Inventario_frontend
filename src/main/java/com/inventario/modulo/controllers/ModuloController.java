...
import com.inventario.modulo.dtos.ModuloRequeridoPatch;
import com.inventario.modulo.dtos.ModuloRequest;
...
public class ModuloController {
     ...
     * @see com.inventario.exceptionHandler.RecursoDuplicadoException
     * @see com.inventario.exceptionHandler.EntidadNoEncontradaException
     */
    @PostMapping
    ...
    * @return una instancia de {@link ResponseEntity} con estado HTTP 204 y sin cuerpo de respuesta.
     * @throws com.inventario.exceptionHandler.custom.RecursoNoEncontradoException si el <code>id</code> proporcionado no
     * corresponde a ningún módulo.
     * @throws com.inventario.exceptionHandler.custom.RecursoDuplicadoException si el nuevo nombre del módulo entra en
     * conflicto con otro registro existente.
     * @throws com.inventario.exceptionHandler.custom.EntidadNoEncontradaException si las referencias a entidades
     ...
     * proyección de datos ({@link com.inventario.subsistema.dto.ModuloResponse}) para entregar una respuesta optimizada,
     ...
     * @see com.inventario.subsistema.services.ModuloService#obtenerModulos(Pageable)
     * @see com.inventario.subsistema.dto.ModuloResponse
     * @since 2026
     */
    @GetMapping
     ...
     * @throws com.inventario.exceptionHandler.RecursoNoEncontradoException si el id proporcionado no corresponde a
     * ningún módulo registrado.
     * @see com.inventario.subsistema.services.ModuloService#obtenerDetalleModulo(Long)
