package com.inventario.modulo.dtos;

/**
 * Representa la estructura detallada de un {@link com.inventario.subsistema.Modulo}, optimizada para operaciones de
 * edición o auditoría.
 * <p>
 ...
 * @param estadoId identificador numérico (ID) del {@link com.inventario.estado.Estado} asignado. Utilizado para
 * inicializar selectores de estado.
 * @param subSistemaId identificador numérico (ID) del {@link com.inventario.subsistema.SubSistema} padre.
 * @param tipoModuloId identificador numérico (ID) del {@link com.inventario.tipomodulo.TipoModulo} que clasifica la
 * naturaleza funcional del módulo.
 * @param tipoAplicacionId identificador numérico (ID) del {@link com.inventario.tipoaplicacion.TipoAplicacion} que
 ...
 * @author jujcgu
 * @version 2.0
 * @see com.inventario.subsistema.Modulo
 * @see ModuloRequest
 * @since 2026
 */
