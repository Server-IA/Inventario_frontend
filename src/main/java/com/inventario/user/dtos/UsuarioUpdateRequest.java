...
public record UsuarioUpdateRequest(
                @Schema(description = "Nombre de usuario (generalmente el correo electrónico)", example = "juan.perez@empresa.com") @NotBlank @Email String username,
                ...
                @Schema(description = "Correo electrónico personal de contacto.", example = "juan.personal@gmail.com") @Email String emailPersonal,
